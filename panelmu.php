    ...
    <div class="container mx-auto mt-20 relative">
        <div class="max-w-3xl bg-white bg-opacity-90 rounded-lg shadow-lg p-6 mx-auto">
            ...
            if (isset($_GET['web'])) {
                ...
                $settingUrl = "https://{$_SERVER['HTTP_HOST']}/{$web}/farelhosting";
                echo "<div>";
                ...
                echo '<a href="' . htmlspecialchars($web) . '/farelhosting" class="btn btn-primary mt-4 inline-block px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg">Buka Panel</a>';
            } else {
